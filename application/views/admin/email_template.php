                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                    <tr>
                      <td align="center" class="es-m-txt-c" style="padding: 0; margin: 0; padding-top: 15px; padding-bottom: 20px;">
                        ...
                        "
                        >
                        <?= ($type == 0) ? 'Incident Report' : 'Compliance Investigation Report' ?>
                      </h1>
                    </td>
                  </tr>
                </table>
...
Hi <?php echo $text; ?> <?php echo $adviser_name; ?>,<br><br>

Please be informed that a <?php echo $system; ?> is being lodged by Eliteinsure representative. We will need your cooperation to complete the investigation.<br><br>

Kindly click the link below to answer questions from the company representative:<br><br>

<a href="<?php echo $link; ?>"><?= ($type == 0) ? 'IR' : 'CIR' ?> Form Link</a><br><br>

Link Password: <?php echo $password; ?><br><br>

Eliteinsure Admin Team<br><br>
...
Please see attached file for final report of <?=$subject?>,<br><br>
